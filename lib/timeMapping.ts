 ...
 */
export function getClassTimes(timeString: string, shift: ShiftType): { startTime: string; endTime: string } | null {
 ...
 */
export function getDaycareTimeRange(shift: ShiftType): { startTime: string; endTime: string } {
  if (shift === 'morning') {
